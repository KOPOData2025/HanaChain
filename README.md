...
- [시스템 아키텍처](#시스템-아키텍처)
- [레포지토리 구조](#레포지토리-구조)
  - [Frontend (hanachain-frontend)](#frontend-hanachain-frontend)
  - [Backend (hanachain-backend)](#backend-hanachain-backend)
  - [FDS (hanachain-fds)](#fds-hanachain-fds)
  - [Blockchain (wearehana-blockchain)](#blockchain-wearehana-blockchain)
...
3. **거래 기록**
   - FDS 승인 시 Web3j를 통해 블록체인에 기록
   - 캠페인 정보 업데이트

4. **거래 내역 확인**
   - 모든 기부 내역이 Sepolia 네트워크에 영구 저장
   - 누구나 [Etherscan](https://etherscan.io)에서 트랜잭션 해시 값으로 거래 확인 가능

### 화면 스크린샷

| | |
|:---------:|:------:|
| <img width="1958" height="1167" alt="image" src="https://github.com/user-attachments/assets/f5721a32-4a1d-40f9-a141-ad6f56507b44" /> <br /> 메인 페이지 | <img width="1958" height="1167" alt="image" src="https://github.com/user-attachments/assets/be488212-779b-4c45-8a27-f48276e68a92" /> <br /> 로그인 |
| <img width="1958" height="1167" alt="image" src="https://github.com/user-attachments/assets/806280d2-a895-4fe2-9a39-c9f464f783ba" /> <br /> 캠페인 리스트 | <img width="1958" height="1167" alt="image" src="https://github.com/user-attachments/assets/daf16700-dcfe-4d03-89d3-453799b34741" /> <br /> 캠페인 상세 조회 |
| <img width="1958" height="1167" alt="image" src="https://github.com/user-attachments/assets/e52ae770-6fd7-4a94-ac57-1d8361bc38a0" /> <br /> 기부 결제 프로세스 | <img width="1958" height="1167" alt="image" src="https://github.com/user-attachments/assets/c36162bd-46f2-4c3a-be3d-545466befebb" /> <br /> 기부 내역 조회 |
| <div width="1958" height="1167" col=2> <img width="44.3%" alt="image" src="https://github.com/user-attachments/assets/87cb8ef7-9486-4005-97c7-5d9c55a895c2" /> <img width="44%" alt="image" src="https://github.com/user-attachments/assets/0dc7a49d-3693-4b32-bd2d-64dead352553" /> </div> 기부 증서 | <img width="1333" height="807" alt="image" src="https://github.com/user-attachments/assets/4b467a76-5cf9-43a1-94f7-320e62a0b4fa" /> <br /> 관리자 대시보드 |
| <img width="1333" height="807" alt="image" src="https://github.com/user-attachments/assets/cd225ece-be5c-4065-b50a-cc2a020ecf28" /> <br /> 캠페인 등록 | <img width="1333" height="807" alt="image" src="https://github.com/user-attachments/assets/26d554ac-acf9-4f6c-9e6b-87e5545db501" /> <br /> FDS 탐지 결과 |
...
- **배치 작업**: Spring Batch를 통한 캠페인 상태 자동 업데이트
...
- **강화학습 기반**: Deep Q-Network (DQN) 알고리즘
  - `src/dqn_model.py`
      - DQN 에이전트 구현
  - `src/trainer.py`
      - 모델 학습 로직
...
### Blockchain (wearehana-blockchain)

#### 폴더 구조

```
wearehana-blockchain/
...
│
├── .taskmaster/                       # Task Master AI 통합
│   ├── tasks/
│   │   └── tasks.json                 # 작업 데이터베이스
│   └── docs/
│       └── blockchain_prd.txt         # 프로젝트 요구사항 명세
│
