-- =====================================================
-- 자금 세탁 패턴 테스트 데이터 생성 스크립트 (DBeaver/DataGrip 호환)
-- =====================================================
...
INSERT INTO users (
    ...
    '$2a$10$YnyIAOU8hLE2BdQWrgADD.oRhCmNITWbS0P2iBicJDSiSdMnSa1sy',
    '김세탁',
    '010-1111-2222',
    'USER',
...
INSERT INTO campaigns (
    ...
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '소아암 환자 치료비 지원'),
    SYSDATE - 1/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '저소득층 학생 장학금'),
    SYSDATE - 2/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '산불 피해 지역 복구 지원'),
    SYSDATE - 3/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '해양 쓰레기 정화 프로젝트'),
    SYSDATE - 4/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '유기동물 보호소 운영'),
    SYSDATE - 5/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '독거노인 무료급식 지원'),
    SYSDATE - 6/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '화재 피해 가정 긴급 지원'),
    SYSDATE - 7/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '희귀병 환자 수술비 지원'),
    SYSDATE - 8/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '농어촌 학교 도서관 구축'),
    SYSDATE - 9/24,
...
INSERT INTO donations (
    ...
    0, '김세탁',
    (SELECT id FROM users WHERE email = 'launderer1@naver.com'),
    (SELECT id FROM campaigns WHERE title = '도심 속 나무 심기 운동'),
    SYSDATE - 10/24,
...
WHERE c.user_id = (SELECT id FROM users WHERE email = 'launderer1@naver.com');
...
SET total_donated_amount = (
    ...
    FROM donations
    WHERE user_id = (SELECT id FROM users WHERE email = 'launderer1@naver.com')
...
WHERE email = 'launderer1@naver.com';
