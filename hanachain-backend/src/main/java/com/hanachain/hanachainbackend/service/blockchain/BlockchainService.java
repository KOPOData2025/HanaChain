...
public interface BlockchainService {
     ...
     * 
     * @param blockchainCampaignId 블록체인 상의 캠페인 ID
     * @return 캠페인 정보 객체
     */
    CampaignInfo getCampaignFromBlockchain(BigInteger blockchainCampaignId);
     ...
     * @return 트랜잭션 해시를 포함한 CompletableFuture
     */
    CompletableFuture<String> finalizeCampaignAsync(BigInteger blockchainCampaignId);
